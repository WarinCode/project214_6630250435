...
<template>
  <Container id="hero" classname="px-[0px] w-full h-screen">
    <div class="w-full h-screen bg-no-repeat bg-center object-cover bg-[url(assets/imgs/hero2.jpg)]">
      <div
        ...
        <Typing :texts="typingTexts" classname="text-4xl font-k2d text-secondary" />
