...
<template>
    <div
        className="skill w-32 h-32 cursor-pointer select-none max-[450px]:w-24 max-[450px]:h-24 max-[360px]:w-24 max-[360px]:h-24">
        ...
        <p
            className="text-base text-center text-tertiary mt-3 transition-all delay-100 ease-in-out max-[360px]:text-sm">
            {{ name }}
        </p>
    </div>
</template>